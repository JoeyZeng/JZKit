...
//压缩图片
- (UIImage*)imageWithImageSimple
{
    CGRect rect_screen = [[UIScreen mainScreen]bounds];
    int MIN_UPLOAD_RESOLUTION = rect_screen.size.width * rect_screen.size.height;// *[UIScreen mainScreen].scale *[UIScreen mainScreen].scale;
    ...
    if (currentResolution > MIN_UPLOAD_RESOLUTION) {
        ...
        newSize = CGSizeMake(self.size.width / factor, self.size.height / factor);
...
//            UIGraphicsBeginImageContext(newSize);
        ...
        [self drawInRect:CGRectMake(0,0,(int)newSize.width,(int)newSize.height)];
